...
\begin{ganttchart}[
	...
	group/.append style={fill=magenta!30},
	link/.style={->, thick}
...
%{\small
	...
	\ganttbar{1.1 Definir el alcance del proyecto}{2023-08-22}{2023-08-30} \\
	\ganttbar{1.2 Acordar metodologías de trabajo}{2023-09-01}{2023-09-10} \\
	\ganttbar{1.3 Gestionar los recursos}{2023-08-22}{2023-10-10} \\
	\ganttbar{1.4 Confeccionar el Plan de Trabajo}{2023-08-22}{2023-10-10} \\
	
	\ganttmilestone{Presentación del Plan de Trabajo}{2023-10-10} \ganttnewline
	
	
	\ganttgroup{2 Simulación y cálculo}{2023-10-16}{2023-12-16} \\
	\ganttbar{2.1 Investigar el estado del arte}{2023-10-16}{2023-11-15} \\
	\ganttbar{2.2 Calcular el circuito}{2023-11-18}{2023-12-02} \\
	\ganttbar{2.3 Simular el comportamiento del circuito}{2023-12-02}{2023-12-16} \\
...
\begin{ganttchart}[
	...
	\ganttbar{3.1 Seleccionar los componentes}{2023-12-18}{2023-12-20} \\
	\ganttbar{3.2 Calcular los circuitos}{2023-12-20}{2023-12-21} \\
	\ganttbar{3.3 Diseñar los circuitos esquemáticos}{2024-01-02}{2024-01-04} \\
	\ganttbar{3.4 Confeccionar memorias de cálculo}{2024-01-04}{2024-01-05} \\
	\ganttbar{3.5 Confeccionar Bill Of Materials (BOM)}{2024-01-05}{2024-01-06} \\
	\ganttbar{3.6 Confeccionar de esquemáticos entregables}{2024-01-08}{2024-01-10} \\
	\ganttbar{3.7 Diseñar el PCBs}{2024-01-10}{2024-02-07} \\
	\ganttbar{3.8 Confeccionar documentos de fabricación}{2024-02-07}{2024-02-08}\\
	\ganttbar{3.9 Modelar 3D del PCB}{2024-02-08}{2024-02-09} \\
	\ganttbar{3.10 Verificar la compatibilidad mecánica}{2024-02-09}{2024-02-09} \\
	
	
	\ganttgroup{4 Fabricación del prototipo}{2024-02-09}{2024-04-07} \\
	\ganttbar{4.1 Buscar proveedores y solicitar cotizaciones}{2024-02-09}{2024-02-15} \\
	\ganttbar{4.2 Rediseñar el PCB}{2024-02-09}{2024-02-15} \\
	\ganttbar{4.3 Dar seguimiento a la fabricación}{2024-02-15}{2024-03-07} \\
\ganttbar{4.4 Montaje y puesta en marcha inicial}{2024-03-07}{2024-04-07} \\
	\ganttbar{4.5 integrar el sistema embebido}{2024-03-07}{2024-04-07} \\
...
link/.style={|-to, line width=0.5pt, magenta},
	...
	\ganttgroup{4 Fabricación del prototipo}{2023-12-18}{2024-01-24} \\
	\ganttbar{4.1 Buscar proveedores y solicitar cotizaciones}{2023-12-18}{2023-12-22} \\
	\ganttbar{4.2 Rediseñar el PCB en función de\* la retroalimentación con el/los fabricantes}{2023-12-25}{2024-01-03} \\
	\ganttbar{4.3 Dar seguimiento a la fabricación}{2024-01-03}{2024-01-12} \\
	\ganttbar{4.4 Montaje de componentes y puesta en marcha inicial}{2024-01-15}{2024-01-24} \\
	\ganttbar{4.5 ntegrar el sistema embebido}{2024-01-15}{2024-01-24} \\
	

	\ganttgroup{5 Desarrollo de Firmware}{2024-01-24}{2024-02-21} \\
	\ganttbar[name=51]{5.1 Estudiar el código actual}{2024-01-24}{2024-01-31} \\
	\ganttbar[name=52]{5.2 Evaluar si recodificar completamente el código o porta}{2024-01-31}{2024-02-14} \\
	\ganttbar[name=53]{5.3 Portar/recodificar las funcionalidades actuales para que funcionen en el nuevo microcontrolador}{2024-02-14}{2024-02-21} \\
	\ganttbar[name=54]{5.4 Desarrollar drivers para las interfaces de comunicación, programación y periféricos}{2024-02-14}{2024-02-21} \\
	\ganttbar[name=55]{5.5 Desarrollar el código de autosintonización}{2024-02-14}{2024-02-21} \\
	\ganttbar[name=56]{5.6 Presentación del Código fuente sin probar}{2024-02-14}{2024-02-21} \\
	
	\ganttgroup{6 Prueba del firmware}{2024-02-21}{2024-03-06} \\
	\ganttbar[name=61]{6.1 Montar periféricos de prueba para verificación de funcionamiento del firmware
}{2024-02-21}{2024-02-28} \\
	\ganttbar{6.2 Prueba de funcionalidad del FW y corrección de bugs}{2024-02-28}{2024-03-06} \\
...
\ganttgroup{7 Diseño de pruebas de validación}{2024-03-06}{2024-05-08} \\
	\ganttbar{7.1 Definir criterios de aceptación del comportamiento de la plataforma}{2024-03-06}{2024-03-20} \\
	\ganttbar{7.2 Definir el alcance de las pruebas a realizarse}{2024-03-20}{2024-03-27} \\
	\ganttbar{7.3 Definir los recursos necesarios}{2024-03-27}{2024-04-03} \\

	
	\ganttgroup{8 Pruebas de validación}{2024-05-08}{2024-05-22} \\
	\ganttbar{8.1 Realizar pruebas de validación}{2024-05-08}{2024-05-22} \\
	\ganttbar{8.2 Culminación de las pruebas de validación}{2024-05-22}{2024-05-22} \\
	\ganttmilestone{8.3 Documentar pruebas de validación}{2024-05-22}
	
	
	
	
	\ganttgroup{9 Presentación final del proyectos}{2024-03-06}{2024-05-08} \\
	\ganttbar{9.1 Confeccionar el informe de avance}{2024-03-06}{2024-03-20} \\
	\ganttbar{9.2 Presentación del Avance del Proyecto}{2024-03-20}{2024-03-27} \\
	\ganttbar{9.3 Confeccionar las memorias del proyecton}{2024-03-27}{2024-04-03} \\
	\ganttbar{9.4 Confeccionar la presentación pública}{2024-04-03}{2024-04-10} \\
	\ganttbar{9.5 Practicar la presentación en conjunto con el director}{2024-04-10}{2024-04-19} \\
	\ganttbar{9.6 Defensa Pública del Proyecto}{2024-04-22}{2024-04-26} \\
